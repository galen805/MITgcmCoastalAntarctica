...
CEOP
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C Added by Weifeng Gordon Zhang on Aug 20, 2020 to link shelfice and
C ptracer packages to consider the influence of ice shelf basal melt on
C the passive tracer
#ifdef ALLOW_PTRACERS
C #include "PTRACERS_SIZE.h"
C
C Modified by Yilang Xu on Aug 20, 2020 to introduce a separate parameter
C PTRACERS_num_shelfice to store the extra dimension for shelficeForcingPT
C This is because MITgcm does not allow defining PTRACERS_num twice in .h files
C This value should always be equal or larger than
C PTRACERS_num in PTRACERS_SIZE.h
      INTEGER PTRACERS_num_shelfice
      PARAMETER(PTRACERS_num_shelfice = 30)
...
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C Added by Weifeng Gordon Zhang on July 11, 2020 to link shelfice and
C ptracer packages to consider the influence of ice shelf basal melt on
C the passive tracer
#ifdef ALLOW_PTRACERS
     &     shelficeForcingPT,
...
C the passive tracer
#ifdef ALLOW_PTRACERS
      _RL shelficeForcingPT     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy,
     &                           PTRACERS_num_shelfice)
#endif /* ALLOW_PTRACERS */
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
